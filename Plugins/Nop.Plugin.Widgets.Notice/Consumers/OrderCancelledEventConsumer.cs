...
{
    public partial class OrderCancelledEventConsumer : IConsumer<OrderCancelledEvent>
    {
        #region Fields
        ...
        public OrderCancelledEventConsumer(ISettingService settingService,
        ...
        public void HandleEvent(OrderCancelledEvent eventMessage)
        {
            ...
            //    if (user != null)
            //    {
            //        user.ReceiveOrderCancelledMessage(
            ...
            //                customer = _customerService.GetCustomerFullName(eventMessage.Order.Customer)
            //            }
            //        );
            //    }
            //}
            _notificationHubContext.Clients.Group(NopCustomerDefaults.AdministratorsRoleName)
                .ReceiveOrderCancelledMessage(
                        _customerService.GetCustomerFullName(_workContext.CurrentCustomer),
                        new
                        {
                            role = "admin: 有撤销订单了：",
