...
namespace Nop.Plugin.Misc.CodeGenerator.Data
{
    //class CodeGeneratorObjectContext
    //{

    //}
    public class CodeGeneratorObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public CodeGeneratorObjectContext(DbContextOptions<CodeGeneratorObjectContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new TableSchemaMap());
            modelBuilder.ApplyConfiguration(new ColumnSchemaMap());
            modelBuilder.ApplyConfiguration(new Nop.Data.Mapping.Common.StringQueryTypeMap());
