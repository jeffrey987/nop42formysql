...
namespace Nop.Plugin.Payments.AliPay
{
    ...
    public partial class AliPayPaymentProcessor
    {
        ...
        public override void Install()
        {
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.AliPay.Instructions", "支付宝支付，有问题联系QQ：954219492@qq.com");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.AliPay.ScanQRCode", "确认订单后，会出现支付二维码，请使用支付宝扫一扫功能，进行支付。如有问题联系QQ：954219492@qq.com");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.AliPay.RedirectionTip", "确认订单后，将打开支付宝在线支付页面，进行支付。如有问题联系QQ：954219492@qq.com");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.AliPay.PaymentMethodDescription", "支付宝支付，支持当面付、手机网站支付、电脑网站支付,有问题请联系QQ，954219492@qq.com");
