...
namespace Nop.Plugin.Payments.AliPay
{
    public partial class RouteProvider : IRouteProvider
    {
        ...
        {
            routeBuilder.MapRoute(AliPayDefaults.ScanCodeRouteName,
            ...
            //MakePayQRCode
            routeBuilder.MapRoute(AliPayDefaults.GenerateQRCodeRouteName,
            ...
            //扫码支付异步通知回调路由名
            routeBuilder.MapRoute(AliPayDefaults.PrecreateNotifyRouteName,
                 "Plugins/PaymentAliPay/Notify",
                 new { controller = "PaymentAliPay", action = "PrecreateNotify" }
                 //new[] { "Nop.Plugin.Payments.AliPay.Controllers" }
            );
            //电脑网站支付异步通知回调路由名
            routeBuilder.MapRoute(AliPayDefaults.PagePayNotifyRouteName,
                 "Plugins/PaymentAliPay/Notify",
                 new { controller = "PaymentAliPay", action = "PagePayNotify" }
                 //new[] { "Nop.Plugin.Payments.AliPay.Controllers" }
            );
            //手机网站支付异步通知回调路由名
            routeBuilder.MapRoute(AliPayDefaults.WapPayNotifyRouteName,
                 "Plugins/PaymentAliPay/Notify",
            ...
            routeBuilder.MapRoute(AliPayDefaults.ReturnRouteName,
