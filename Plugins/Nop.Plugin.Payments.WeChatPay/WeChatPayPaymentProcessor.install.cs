...
namespace Nop.Plugin.Payments.WeChatPay
{
    public partial class WeChatPayPaymentProcessor
    {
        ...
        public override void Install()
        {
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.WeChatPay.Instructions", "微信扫码支付，有问题联系QQ：954219492@qq.com");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.WeChatPay.ScanQRCode", "确认订单后，会出现支付二维码，请使用我微信扫一扫功能，进行支付。如有问题联系QQ：954219492@qq.com");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.WeChatPay.RedirectionTip", "确认订单后，将打开微信在线支付页面，进行支付。如有问题联系QQ：954219492@qq.com");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.WeChatPay.PaymentMethodDescription", "微信支付，支持付款码、Native、H5支付,有问题请联系QQ，954219492@qq.com");
