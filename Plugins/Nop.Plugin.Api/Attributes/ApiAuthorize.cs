namespace Nop.Plugin.Api.Attributes
{
    ...
    public class ApiAuthorize : AuthorizeAttribute
    {
        ...
        {
            var pluginService = Core.Infrastructure.EngineContext.Current.Resolve<IPluginService>();
            var pluginInstalled = pluginService.GetPluginDescriptorBySystemName<IPlugin>("Nop.Plugin.Api")?.Installed ?? false;
